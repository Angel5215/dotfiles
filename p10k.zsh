# Generated by Powerlevel10k configuration wizard on 2020-09-12 at 13:48 CDT with custom modifications.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${clean}${(g::)POWERLEVEL9K_VCS_STATUS_TAG_ICON}"
    ...
    [[ -z $where ]] && res+="${clean}${(g::)POWERLEVEL9K_VCS_STATUS_COMMIT_ICON}${VCS_STATUS_COMMIT[1,8]}"

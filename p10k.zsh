# Generated by Powerlevel10k configuration wizard on 2020-02-29 with custom modifications.
...
() {
  ...
  POWERLEVEL9K_VCS_STATUS_PUSH_COMMITS_BEHIND_ICON=${(g::)POWERLEVEL9K_VCS_STATUS_PUSH_COMMITS_BEHIND_ICON}
  
  # PUSH COMMITS AHEAD
  typeset -g POWERLEVEL9K_VCS_STATUS_PUSH_COMMITS_AHEAD_ICON='⇢'
  POWERLEVEL9K_VCS_STATUS_PUSH_COMMITS_AHEAD_ICON=${(g::)POWERLEVEL9K_VCS_STATUS_PUSH_COMMITS_AHEAD_ICON}
  ...
  function my_git_formatter() {
    ...
    [[ -z $where ]] && res+="${clean}${POWERLEVEL9K_VCS_STATUS_COMMIT_ICON}${VCS_STATUS_COMMIT[1,8]}"
    ...
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean}${POWERLEVEL9K_VCS_STATUS_PUSH_COMMITS_BEHIND_ICON}${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ⇢42 if ahead of the push remote; no leading space if also behind: ⇠42⇢42.
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+="${clean}${POWERLEVEL9K_VCS_STATUS_PUSH_COMMITS_AHEAD_ICON}${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    # *42 if have stashes.

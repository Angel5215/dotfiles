# Generated by Powerlevel10k configuration wizard on 2023-04-09 at 02:07 CST.
...
# lightest, 12h time, vertical separators, sharp heads, flat tails, 2 lines, dotted,
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}${(g::)POWERLEVEL9K_VCS_STATUS_CONFLICTED_ICON}${VCS_STATUS_NUM_CONFLICTED}"
    # +42 if have staged changes.
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}${(g::)POWERLEVEL9K_VCS_STATUS_STAGED_ICON}${VCS_STATUS_NUM_STAGED}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}${(g::)POWERLEVEL9K_VCS_STATUS_UNSTAGED_ICON}${VCS_STATUS_NUM_UNSTAGED}"
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='[%B$P9K_IP_INTERFACE%b] %38F$P9K_IP_IP'

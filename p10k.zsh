# Generated by Powerlevel10k configuration wizard on 2020-02-02 at 23:36 CST.
...
() {
  ...
  function my_git_formatter() {
    ...
    [[ -z $where ]] && res+="${clean}${POWERLEVEL9K_VCS_STATUS_COMMIT_ICON}${clean}${VCS_STATUS_COMMIT[1,8]}"

# Generated by Powerlevel10k configuration wizard and modified by me.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
      ...
      # =========================[ Line #2 ]=========================
      newline
      # ADD ANY OTHER SEGMENTS HERE
  )

  # The list of segments shown on the right. Fill it with less important segments.
  # It gets hidden if any segments in the left overlap with these segments.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
      # =========================[ Line #1 ]=========================
      status                  # exit code of the last command
      background_jobs         # presence of background jobs
      ip                      # current local IP
      time                    # current time (displayed in HH:mm format)
      # =========================[ Line #2 ]=========================
      newline
  ...
  # USE NERD FONTS TO DISPLAY ICONS. This option makes a difference only when default icons are
  # enabled for all or some prompt segments.
  ...
  #typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%255F─╮'
  #typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%255F─┤'
  #typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%255F─╯'
  ...
  # ALL CONFIGURATIONS BELOW THIS POINT ARE GENERATED WITH EXCEPTIONS OF A FEW COLORS,
  # IP SEGMENT DEFINITION AND SHOWING THE CONTEXT AT ALL TIMES.
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
